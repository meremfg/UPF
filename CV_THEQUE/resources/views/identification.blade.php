                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="col-md-8" style="text-align: center;">
                                                <label for="user_image" style="padding:10px;padding-bottom:20px;padding-top:20px;background: #d0d0d0;margin-bottom: 0rem;border-radius: 15px;width: 65%;height:28%">
